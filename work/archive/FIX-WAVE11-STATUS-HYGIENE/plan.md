...
## Closeout (authorized after independent review PASS)

On review PASS, closeout may:

- mark progress COMPLETED;
- archive `work/active/FIX-WAVE11-STATUS-HYGIENE/` to `work/archive/FIX-WAVE11-STATUS-HYGIENE/`;
- delete:work/ACTIVE.json
- update `work/QUEUE.md` and `HANDOFF.md`;
- queue `IMPLEMENT-PORTABLE-DEBINA-DESIGN-COUNCIL` without creating a new ACTIVE.json.
