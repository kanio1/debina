...
**Input**: Feature specification from `work/active/PILOT-DEBINA-SPEC-KIT-MICRO-FEATURE/specs/001-markdown-h1-checker/spec.md`
...
### Source Code (planned — Phase B only)
