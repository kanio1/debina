...
KNOWN={"EU-LAW","EPC-SCT","EPC-SCT-INST","ISO20022","TIPS","STEP2","RT1","STET","PROJECT-ADR","PROJECT_SIMULATION","ASSUMPTION","OPEN-QUESTION","PARTICIPANT_DOCUMENTATION_REQUIRED"}
RAIL_STATUS={"APPLICABLE","APPLICABLE-WITH-RAIL-EXTENSION","NOT-APPLICABLE","PROJECT_SIMULATION","SOURCE_BLOCKED","PARTICIPANT_DOCUMENTATION_REQUIRED"}
def main():
