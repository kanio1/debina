...
## Extensions/failures
2a no context: record unresolved case. 4a deadline/eligibility unknown: SOURCE-BLOCKED. 5a transport failure remains transport state only.
## Rules/sources/rails
BR-RTRANS-003; EPC/ISO sources; rail applicability SOURCE-BLOCKED/PARTICIPANT-DOCUMENTATION-REQUIRED. camt.056/camt.029 are messages, not goals.
## Quality/data/architecture
QS-TRC-01/QS-REL-02; future case, egress and ISO; `BOUNDARY-REVIEW-CANDIDATE`. A request, B response, both SOURCE-BLOCKED. Examples known/unknown original, response; questions source profile/time; out auto-reversal. EPIC-65–70.
