...
| FLOW-GAP-004 | CRITICAL | `DISPATCHED` jest terminalny i zapisany `is_final=true` | PaymentTransitionTable, PaymentHistoryRecorder, V20/test | Delivery utożsamione z finality | Payment/settlement: wdrożyć five-axis model z EPIC-39/47; mutation tests |
