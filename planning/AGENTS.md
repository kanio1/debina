...
For new or materially changed business work, apply `enterprise-use-case-engineering` and record a use-case slice, source trace, applicable rules, quality scenario, architecture realization and `semantic_enforcement: ENFORCED` marker before claiming `READY`. EPIC-76 is the C1 `PILOT`; legacy work migrates under `docs/governance/SEMANTIC-ENFORCEMENT-MIGRATION.md`.
