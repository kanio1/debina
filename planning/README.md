...
| EPIC-35 — Settlement: resolver strategii | in-progress (Story 35.1 **done** 2026-07-17 — `SettlementStrategyResolver(settlement_basis, liquidity_mode)`, 17/17 PASS, mutation-proof 3x, fail-closed 4-pair MVP matrix; Story 35.2 analytically `READY`; Story 35.3 `[CAPABILITY-BLOCKED]` — `scheme_profiles` has no `settlement_basis`/`liquidity_mode`/`finality_rule` columns; patrz epic file) | EPIC-12/Story 12.1 | [epics/EPIC-35-settlement-strategy-resolver.md](epics/EPIC-35-settlement-strategy-resolver.md) |
