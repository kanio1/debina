...
| D — local Dagger Go SDK | C1/C2 plus methodology assurance and supported commands | local fast/integration/smoke/all | GitHub Actions, act, remote CI, deployment/release | direct local invocation works; `rebase/phase-d-local-dagger` |
