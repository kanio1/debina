-- Forward fix: NULLIF is SQL syntax, not a schema-qualified pg_catalog function.
-- V55/V56 were never edited; this replaces only the function body before production promotion.
...
DECLARE
    ...
    v_tenant_context text := NULLIF(pg_catalog.current_setting('app.tenant_id', true), '');
