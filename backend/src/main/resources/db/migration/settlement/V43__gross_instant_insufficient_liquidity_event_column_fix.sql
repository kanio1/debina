-- Forward correction for V41: settlement_attempt_events is keyed by attempt_id.
CREATE OR REPLACE FUNCTION settlement.record_gross_instant_insufficient_liquidity(
...
BEGIN
    ...
    INSERT INTO settlement.settlement_attempt_events (attempt_id, seq, state, at)
