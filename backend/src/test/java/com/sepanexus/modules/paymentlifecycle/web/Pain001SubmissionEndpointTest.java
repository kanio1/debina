...
class Pain001SubmissionEndpointTest {
    ...
    void validSignedPain001CreatesPaymentWithIdentifiersLineageAndOutbox() throws Exception {
        ...
        assertThat(count("SELECT count(*) FROM payment.payments WHERE end_to_end_id = 'E2E-HAPPY'")).isEqualTo(1);
        ...
        assertThat(count("SELECT count(*) FROM iso.message_lineage ml "
                + "JOIN payment.payments p ON p.id = ml.payment_id "
                + "WHERE p.end_to_end_id = 'E2E-HAPPY' AND ml.lineage_role = 'ORIGINAL_INSTRUCTION'")).isEqualTo(1);
        assertThat(count("SELECT count(*) FROM payment.outbox_events oe "
                + "JOIN payment.payments p ON p.id = oe.aggregate_id WHERE p.end_to_end_id = 'E2E-HAPPY'"))
                .isEqualTo(1);
    ...
    void tamperedSignatureRejectsWithoutCreatingPaymentButArchivesEvidence() throws Exception {
        ...
        assertThat(count("SELECT count(*) FROM payment.payments WHERE end_to_end_id = 'E2E-TAMPER'")).isZero();
    ...
    void missingRequiredSignatureRejectsWithoutCreatingPayment() throws Exception {
        ...
        assertThat(count("SELECT count(*) FROM payment.payments WHERE end_to_end_id = 'E2E-NOSIG'")).isZero();
        assertThat(count("SELECT count(*) FROM iso.iso_message_parse_errors")).isZero();
    }
    ...
    void unsupportedPain001VersionRejectedWithoutCreatingPaymentOrParseError() throws Exception {
        ...
        assertThat(count("SELECT count(*) FROM payment.payments WHERE end_to_end_id = 'E2E-VER'")).isZero();
        assertThat(count("SELECT count(*) FROM iso.iso_message_parse_errors"))
    ...
    void repeatedSubmissionWithSameIdempotencyKeyReplaysSamePayment() throws Exception {
        ...
        assertThat(count("SELECT count(*) FROM payment.payments WHERE end_to_end_id = 'E2E-REPLAY'")).isEqualTo(1);
    }
    ...
    void sameIdempotencyKeyDifferentBodyIsConflict() throws Exception {
        ...
        assertThat(count("SELECT count(*) FROM payment.payments WHERE end_to_end_id = 'E2E-CONFLICT-2'")).isZero();
    }
    ...
    void unauthorizedRoleIsRejected() throws Exception {
        ...
        assertThat(count("SELECT count(*) FROM payment.payments WHERE end_to_end_id = 'E2E-ROLE'")).isZero();
    }
